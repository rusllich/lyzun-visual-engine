          ...
          <div className="grid border-b border-[var(--line)] lg:grid-cols-[0.42fr_1.58fr]">
            ...
            <div className="min-h-[560px] py-10 lg:px-12 lg:py-12 xl:px-16">
              <AnimatePresence mode="wait">
                {step === 1 && (
                  <motion.div key="one" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
                ...
                {step === 3 && (
                  <motion.div key="three" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
                ...
                {step === 4 && (
                  <motion.div key="four" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
              ...
              <div className="mt-12 flex items-center justify-between border-t border-[var(--line)] pt-6">
                ...
                {step < 4 ? (
                  ...
                  <button type="button" disabled={!form.name.trim() || !form.email.trim() || status === "submitting"} onClick={submit} className="cta disabled:cursor-not-allowed disabled:opacity-20">{status === "submitting" ? "Sending…" : "Submit brief ↗"}</button>
                )}
              </div>
            </div>
          </div>
